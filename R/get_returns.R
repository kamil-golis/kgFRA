#' A function that calculates daily log-returns for a given stock over a given time horizon
#'
#' @author Kamil Golis
...
#' @return An xts object with daily log-returns of the stock is returned.
#' @examples
#' get_returns('AAPL')
#' get_returns('MSFT', '2020-01-01', '2022-03-31', 'open')
#' @export

get_returns <-  function(symbol, start_date=Sys.Date()-365, end_date=Sys.Date(), price_type = 'close') {
